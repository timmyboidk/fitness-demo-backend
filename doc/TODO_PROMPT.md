# AI 任务提示词：完成健身后端核心欠缺功能

你现在是一名资深 Java 后端开发工程师，负责完善一个基于 Spring Boot 的健身应用后端项目。目前项目骨架已搭建，但部分核心业务逻辑仍为 Mock 实现。请按照以下任务清单，结合业务最佳实践进行代码实现。
...
---
**请根据上述要求，开始你的代码编写，目标是交付一个可直接在腾讯云/阿里云等公网环境运行的生产级后端。**
